...
app.get("/results", function(req, res) {
    ...
    request("https://na1.api.riotgames.com/lol/summoner/v3/summoners/by-name/" + queryPlayer + "?api_key=RGAPI-990d672e-3477-414d-bcee-8ac632d3003b", function(error, response, body) {
       if (!error && response.statusCode == 200) {
           ...
           request("https://na1.api.riotgames.com/lol/match/v3/matchlists/by-account/" + queryAccountID + "?api_key=RGAPI-990d672e-3477-414d-bcee-8ac632d3003b", function(error, response, body) {
                if (!error && response.statusCode == 200) {
                    ...
                    request("https://na1.api.riotgames.com/lol/match/v3/matches/" + matchID + "?api_key=RGAPI-990d672e-3477-414d-bcee-8ac632d3003b", function(error, response, body) {
                        if (!error && response.statusCode == 200) {
    ...
    request("https://na1.api.riotgames.com/lol/summoner/v3/summoners/by-name/" + queryOpponent + "?api_key=RGAPI-990d672e-3477-414d-bcee-8ac632d3003b", function(error, response, body) {
       if (!error && response.statusCode == 200) {
    ...
    var delayInMilliseconds = 2000; // renders all of the data
